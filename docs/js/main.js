...
/* harmony import */ var _components_scroll_benefits__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/scroll-benefits */ "./src/js/components/scroll-benefits.js");
/* harmony import */ var _components_scroll_heating__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/scroll-heating */ "./src/js/components/scroll-heating.js");
...
/* harmony import */ var _components_marquee__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/marquee */ "./src/js/components/marquee.js");
/* harmony import */ var _components_marquee__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_marquee__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var _vendor_imask_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendor_imask_js__WEBPACK_IMPORTED_MODULE_1__);
...
if (accordion) {
  ...
  items.forEach(el => {
    el.querySelector('.accord__header').addEventListener('click', e => {
      ...
      el.classList.contains('active') ? currentDesc.style.maxHeight = currentDesc.scrollHeight + 'px' : currentDesc.style.maxHeight = null;
    });
  });
}
...
/***/ "./src/js/components/scroll-benefits.js":
/*!**********************************************!*\
  !*** ./src/js/components/scroll-benefits.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/js/components/scroll-heating.js":
/*!*********************************************!*\
  !*** ./src/js/components/scroll-heating.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
if (heatingVideo) {
  ...
  mm.add('(min-width: 769px)', () => {
    ...
    timeline.to(heatingVideo, {
      clipPath: 'circle(100% at 25% 50%)'
    }).set(heatingVideo, {
      clipPath: 'inset(0%)'
    }).to(heatingVideo, {
    ...
    const timeline2 = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline();
    var slides = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.toArray(".video-block__slide");
    slides.forEach(el => {
      timeline2.to(el, {
        opacity: 1,
        scrollTrigger: {
    ...
    const timeline3 = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline();
    timeline3.to('.video-block', {
      yPercent: () => -100
    });
    gsap_all__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.create({
      trigger: '.heating',
    ...
    const timeline4 = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline();
    timeline4.to('.heating__header', {
      yPercent: () => -200
    });
    gsap_all__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.create({
      trigger: '.heating',
...
swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_1__.Autoplay]);
window.addEventListener('DOMContentLoaded', () => {
  ...
  resizableSwiper('(max-width: 768px)', '.compos__slider', {
    slidesPerView: 1,
    pagination: {
