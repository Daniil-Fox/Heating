...
const partnersSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.partners__slider', {
  slidesPerView: 3.9,
  loop: true,
  speed: 2000,
  autoplay: {
...
const initSlider = () => {
  if (window.matchMedia('(max-width: 768px)').matches) {
    ...
    const composSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.compos__slider', {
      slidesPerView: 1,
      pagination: {
